    ...
    return(
        <>
            <div className="bg-black h-screen w-full flex items-center justify-center flex-col gap-4">
                <div>
                    <h1>Docker Setup Projects</h1>
                    <p className="text-gray-400">A project to set up Docker for development and deployment.</p>
                </div>

                <div className="w-full flex items-center justify-center mt-8">
                    <div className="w-1/3 h-90 flex items-center justify-center border border-white rounded-3xl relative overflow-hidden">
                        <Image src={DockerImage} className="object-cover" alt="Docker Image" fill />
                    </div>
